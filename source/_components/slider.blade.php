...
>
        ...
        <div class="w-full flex items-center justify-end space-x-4 text-indigo-600 text-xs mt-4">
            <button class="uppercase hover:underline focus:underline focus:outline-none" :class="{ 'text-gray-500' : selected === 0 }" @click="selected > 0 ? selected-- : null">
            ...
            <button class="uppercase hover:underline focus:underline focus:outline-none" :class="{ 'text-gray-500' : selected === (images.length - 1) }" @click="selected < (images.length - 1) ? selected ++ : null">
