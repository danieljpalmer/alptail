...
<button 
    ...
    class="w-full cursor-pointer border border-dashed border-gray-300 rounded focus:outline-none focus:shadow-outline cursor-pointer px-16 py-12 flex flex-col items-center justify-center text-gray-500 text-center transition duration-150 hover:border-gray-400"  
