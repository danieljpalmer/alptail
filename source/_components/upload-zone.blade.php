...
class="relative border border-gray-200 rounded px-16 py-12 flex flex-col items-center justify-center text-gray-500 transition duration-150 hover:border-gray-400" :class="file !== null ? 'text-primary' : 'hover:text-gray-600'">
