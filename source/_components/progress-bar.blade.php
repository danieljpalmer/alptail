...
>
    ...
    <div class="flex items-center justify-end space-x-2 text-teal-500 mt-2">
        <button  @click="value = +value - 10" aria-label="Previous Image" class="p-1 focus:outline-none focus:shadow-outline rounded" :class="{ 'text-gray-400' : value === 0 }">
        ...
        <button @click="value = +value + 10" aria-label="Next Image" class="p-1 focus:outline-none focus:shadow-outline rounded" :class="{ 'text-gray-400' : value >= total }">
