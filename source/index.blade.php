...
@section('body')
    ...
    <main class="max-w-4xl mt-10 space-y-10 sm:space-y-16">
        ...
        @include('_container/shell', ['name' => 'Modal', 'link' => 'https://github.com/danieljpalmer/alpine-tail/blob/master/source/_components/countdown-clock.blade.php', 'component' => 'modal'])
